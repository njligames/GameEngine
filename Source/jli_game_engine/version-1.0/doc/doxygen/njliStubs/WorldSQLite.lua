...
local function WorldSQLite_updateFile_filename_filename_offset_size_buffer()
--//! [WorldSQLite_updateFile_filename_filename_offset_size_buffer]
-- @TODO: Test: WorldSQLite:updateFile(filename, filename, offset, size, buffer)
--//! [WorldSQLite_updateFile_filename_filename_offset_size_buffer]
