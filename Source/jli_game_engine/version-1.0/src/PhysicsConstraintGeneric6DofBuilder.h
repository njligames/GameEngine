...
namespace njli
{
     ...
     *  <#Description#>
     */
    ATTRIBUTE_ALIGNED16(class) PhysicsConstraintGeneric6DofBuilder :
    public AbstractBuilder
    {
        friend class WorldFactory;
    protected:
        PhysicsConstraintGeneric6DofBuilder();
        PhysicsConstraintGeneric6DofBuilder(const PhysicsConstraintGeneric6DofBuilder &);
        BT_DECLARE_ALIGNED_ALLOCATOR();
        virtual ~PhysicsConstraintGeneric6DofBuilder();
        
        PhysicsConstraintGeneric6DofBuilder &operator=(const PhysicsConstraintGeneric6DofBuilder &);
    ...
    public:
         ...
         */
        static void destroyArray(PhysicsConstraintGeneric6DofBuilder **array, const u32 size = 0);
        /**
         *  <#Description#>
         *
         *  @return <#return value description#>
         ...
         *  @return <#return value description#>
         */
        static PhysicsConstraintGeneric6DofBuilder *clone(const PhysicsConstraintGeneric6DofBuilder &object);
        /**
         *  <#Description#>
         *
         *  @param object <#object description#>
         ...
         */
        static void load(PhysicsConstraintGeneric6DofBuilder &object, lua_State *L, int stack_index);
        /**
         *  <#Description#>
         *
         *  @return <#return value description#>
