...
namespace njli
{
    ...
    public:
         ...
         *  @return <#return value description#>
         */
        static NodeStateMachineBuilder **createArray(const u32 size);
        /**
         *  <#Description#>
         *
         *  @param array <#array description#>
         */
        static void destroyArray(NodeStateMachineBuilder **array, const u32 size = 0);
        /**
         *  <#Description#>
         *
         *  @return <#return value description#>
         */
        static NodeStateMachineBuilder *create();
        /**
         *  <#Description#>
         *
         ...
         *  @return <#return value description#>
         */
        static NodeStateMachineBuilder *clone(const NodeStateMachineBuilder &object);
        /**
         *  <#Description#>
         *
         *  @param object <#object description#>
         */
        static void destroy(NodeStateMachineBuilder *object);
        /**
         *  <#Description#>
         *
         *  @param object      <#object description#>
         ...
         */
        static void load(NodeStateMachineBuilder &object, lua_State *L, int stack_index);
        /**
         *  <#Description#>
         *
         *  @return <#return value description#>
