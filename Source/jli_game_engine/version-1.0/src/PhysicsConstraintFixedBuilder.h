...
namespace njli
{
     ...
     *  <#Description#>
     */
    ATTRIBUTE_ALIGNED16(class) PhysicsConstraintFixedBuilder :
    ...
    protected:
        ...
        PhysicsConstraintFixedBuilder &operator=(const PhysicsConstraintFixedBuilder &);
    ...
    public:
         ...
         */
        static void destroyArray(PhysicsConstraintFixedBuilder **array, const u32 size = 0);
        /**
         *  <#Description#>
         *
         *  @return <#return value description#>
         ...
         *  @return <#return value description#>
         */
        static PhysicsConstraintFixedBuilder *clone(const PhysicsConstraintFixedBuilder &object);
        /**
         *  <#Description#>
         *
         *  @param object <#object description#>
         ...
         */
        static void load(PhysicsConstraintFixedBuilder &object, lua_State *L, int stack_index);
        /**
         *  <#Description#>
         *
         *  @return <#return value description#>
