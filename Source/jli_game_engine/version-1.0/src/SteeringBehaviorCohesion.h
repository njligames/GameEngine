...
namespace njli
{
     ...
     *  <#Description#>
     */
    ATTRIBUTE_ALIGNED16(class) SteeringBehaviorCohesion:
    ...
    public:
        ...
        *  @snippet SteeringBehaviorCohesion.lua SteeringBehaviorCohesion_calculateSerializeBufferSize_
        */
         ...
         *  @snippet SteeringBehaviorCohesion.lua SteeringBehaviorCohesion_calculateSerializeBufferSize_
         */
        static void destroyArray(SteeringBehaviorCohesion * *array, const u32 size = 0);
         ...
         *  @snippet SteeringBehaviorCohesion.lua SteeringBehaviorCohesion_calculateSerializeBufferSize_
         */
        static SteeringBehaviorCohesion* create(const SteeringBehaviorCohesionBuilder& builder);
         ...
         *  @snippet SteeringBehaviorCohesion.lua SteeringBehaviorCohesion_calculateSerializeBufferSize_
         */
        static SteeringBehaviorCohesion* clone(const SteeringBehaviorCohesion& object);
         ...
         *  @snippet SteeringBehaviorCohesion.lua SteeringBehaviorCohesion_calculateSerializeBufferSize_
         */
        static SteeringBehaviorCohesion* copy(const SteeringBehaviorCohesion& object);
         ...
         *  @snippet SteeringBehaviorCohesion.lua SteeringBehaviorCohesion_calculateSerializeBufferSize_
         */
        static void load(SteeringBehaviorCohesion & object, lua_State * L, int stack_index);
