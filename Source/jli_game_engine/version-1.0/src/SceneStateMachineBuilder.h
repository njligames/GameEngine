...
namespace njli
{
    ...
    public:
         ...
         */
        static void destroyArray(SceneStateMachineBuilder **array, const u32 size = 0);
        /**
         *  <#Description#>
         *
         *  @return <#return value description#>
         ...
         *  @return <#return value description#>
         */
        static SceneStateMachineBuilder *clone(const SceneStateMachineBuilder &object);
        /**
         *  <#Description#>
         *
         *  @param object <#object description#>
         ...
         */
        static void load(SceneStateMachineBuilder &object, lua_State *L, int stack_index);
        /**
         *  <#Description#>
         *
         *  @return <#return value description#>
