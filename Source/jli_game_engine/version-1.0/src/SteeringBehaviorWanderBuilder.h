...
namespace njli
{
     ...
     *  Builder for <#CLASS#>
     */
    ATTRIBUTE_ALIGNED16(class) SteeringBehaviorWanderBuilder :
    ...
    protected:
        ...
        SteeringBehaviorWanderBuilder &operator=(const SteeringBehaviorWanderBuilder &);
    ...
    public:
         ...
         */
        static void destroyArray(SteeringBehaviorWanderBuilder **array, const u32 size = 0);
        /**
         ...
         *  @return Pointer to the newly created instance.
         */
        static SteeringBehaviorWanderBuilder *clone(const SteeringBehaviorWanderBuilder &object);
        /**
         ...
         */
        static void load(SteeringBehaviorWanderBuilder &object, lua_State *L, int stack_index);
        /**
         *  Get the type of ::jliObjectEnumType enum value.
         *
         *  @return The ::jliObjectEnumType enum value.
