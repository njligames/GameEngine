...
namespace njli
{
     ...
     *  Builder for <#CLASS#>
     */
    ATTRIBUTE_ALIGNED16(class) SteeringBehaviorCohesionBuilder :
    ...
    protected:
        ...
        SteeringBehaviorCohesionBuilder &operator=(const SteeringBehaviorCohesionBuilder &);
    ...
    public:
         ...
         */
        static void destroyArray(SteeringBehaviorCohesionBuilder **array, const u32 size = 0);
        /**
         ...
         *  @return Pointer to the newly created instance.
         */
        static SteeringBehaviorCohesionBuilder *clone(const SteeringBehaviorCohesionBuilder &object);
        /**
         ...
         */
        static void load(SteeringBehaviorCohesionBuilder &object, lua_State *L, int stack_index);
        /**
         *  Get the type of ::jliObjectEnumType enum value.
         *
         *  @return The ::jliObjectEnumType enum value.
