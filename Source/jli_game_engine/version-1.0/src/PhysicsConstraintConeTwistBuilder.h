...
namespace njli
{
     ...
     *  <#Description#>
     */
    ATTRIBUTE_ALIGNED16(class) PhysicsConstraintConeTwistBuilder :
    public AbstractBuilder
    {
        friend class WorldFactory;
    protected:
        PhysicsConstraintConeTwistBuilder();
        PhysicsConstraintConeTwistBuilder(const PhysicsConstraintConeTwistBuilder &);
        BT_DECLARE_ALIGNED_ALLOCATOR();
        virtual ~PhysicsConstraintConeTwistBuilder();
        
        PhysicsConstraintConeTwistBuilder &operator=(const PhysicsConstraintConeTwistBuilder &);
    ...
    public:
         ...
         */
        static void destroyArray(PhysicsConstraintConeTwistBuilder **array, const u32 size = 0);
        /**
         *  <#Description#>
         *
         *  @return <#return value description#>
         ...
         *  @return <#return value description#>
         */
        static PhysicsConstraintConeTwistBuilder *clone(const PhysicsConstraintConeTwistBuilder &object);
        /**
         *  <#Description#>
         *
         *  @param object <#object description#>
         ...
         */
        static void load(PhysicsConstraintConeTwistBuilder &object, lua_State *L, int stack_index);
        /**
         *  <#Description#>
         *
         *  @return <#return value description#>
