...
namespace njli
{
     ...
     *  <#Description#>
     */
    ATTRIBUTE_ALIGNED16(class) PhysicsShapeConvexTriangleMeshBuilder :
    public AbstractBuilder
    {
        friend class WorldFactory;
    protected:
        PhysicsShapeConvexTriangleMeshBuilder();
        PhysicsShapeConvexTriangleMeshBuilder(const PhysicsShapeConvexTriangleMeshBuilder &);
        BT_DECLARE_ALIGNED_ALLOCATOR();
        virtual ~PhysicsShapeConvexTriangleMeshBuilder();
        
        PhysicsShapeConvexTriangleMeshBuilder &operator=(const PhysicsShapeConvexTriangleMeshBuilder &);
    ...
    public:
         ...
         */
        static void destroyArray(PhysicsShapeConvexTriangleMeshBuilder **array, const u32 size = 0);
        /**
         *  <#Description#>
         *
         *  @return <#return value description#>
         ...
         *  @return <#return value description#>
         */
        static PhysicsShapeConvexTriangleMeshBuilder *clone(const PhysicsShapeConvexTriangleMeshBuilder &object);
        /**
         *  <#Description#>
         *
         *  @param object <#object description#>
         ...
         */
        static void load(PhysicsShapeConvexTriangleMeshBuilder &object, lua_State *L, int stack_index);
        /**
         *  <#Description#>
         *
         *  @return <#return value description#>
