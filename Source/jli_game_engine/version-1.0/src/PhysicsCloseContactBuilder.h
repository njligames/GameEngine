...
namespace njli
{
    ATTRIBUTE_ALIGNED16(class) PhysicsCloseContactBuilder :
    ...
    public:
         ...
         */
        static void destroyArray(PhysicsCloseContactBuilder **array, const u32 size = 0);
        /**
         *  <#Description#>
         *
         *  @return <#return value description#>
         ...
         *  @return <#return value description#>
         */
        static PhysicsCloseContactBuilder *clone(const PhysicsCloseContactBuilder &object);
        /**
         *  <#Description#>
         *
         *  @param object <#object description#>
         ...
         */
        static void load(PhysicsCloseContactBuilder &object, lua_State *L, int stack_index);
        /**
         *  <#Description#>
         *
         *  @return <#return value description#>
