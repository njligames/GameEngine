...
namespace njli
{
    ...
    public:
         ...
         *  @return <#return value description#>
         */
        static CollisionResponseBuilder **createArray(const u32 size);
        /**
         *  <#Description#>
         *
         *  @param array <#array description#>
         */
        static void destroyArray(CollisionResponseBuilder **array, const u32 size = 0);
        /**
         *  <#Description#>
         *
         *  @return <#return value description#>
         */
        static CollisionResponseBuilder *create();
        /**
         *  <#Description#>
         *
         ...
         *  @return <#return value description#>
         */
        static CollisionResponseBuilder *clone(const CollisionResponseBuilder &object);
        /**
         *  <#Description#>
         *
         *  @param object <#object description#>
         */
        static void destroy(CollisionResponseBuilder *object);
        /**
         *  <#Description#>
         *
         *  @param object      <#object description#>
         ...
         */
        static void load(CollisionResponseBuilder &object, lua_State *L, int stack_index);
        /**
         *  <#Description#>
         *
         *  @return <#return value description#>
