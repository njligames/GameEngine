...
namespace njli
{
     ...
     *  <#Description#>
     */
    ATTRIBUTE_ALIGNED16(class) PhysicsShapeMultiSphereBuilder :
    ...
    protected:
        ...
        PhysicsShapeMultiSphereBuilder &operator=(const PhysicsShapeMultiSphereBuilder &);
    ...
    public:
         ...
         */
        static void destroyArray(PhysicsShapeMultiSphereBuilder **array, const u32 size = 0);
        /**
         *  <#Description#>
         *
         *  @return <#return value description#>
         ...
         *  @return <#return value description#>
         */
        static PhysicsShapeMultiSphereBuilder *clone(const PhysicsShapeMultiSphereBuilder &object);
        /**
         *  <#Description#>
         *
         *  @param object <#object description#>
         ...
         */
        static void load(PhysicsShapeMultiSphereBuilder &object, lua_State *L, int stack_index);
        /**
         *  <#Description#>
         *
         *  @return <#return value description#>
