...
#ifndef SteeringBehaviorBuilder_hpp
#define SteeringBehaviorBuilder_hpp
...
namespace njli
{
     ...
     *  Builder for <#CLASS#>
     */
    ATTRIBUTE_ALIGNED16(class) SteeringBehaviorBuilder :
    public AbstractBuilder
    {
        friend class WorldFactory;
    protected:
        SteeringBehaviorBuilder();
        SteeringBehaviorBuilder(const SteeringBehaviorBuilder &);
        BT_DECLARE_ALIGNED_ALLOCATOR();
        virtual ~SteeringBehaviorBuilder();
        
        SteeringBehaviorBuilder &operator=(const SteeringBehaviorBuilder &);
    ...
    public:
         ...
         */
        static SteeringBehaviorBuilder **createArray(const u32 size);
        /**
         *  Destroy an Array of this class type.
         *
         *  @param array The Pointer to the array to delete.
         */
        static void destroyArray(SteeringBehaviorBuilder **array, const u32 size = 0);
        /**
         *  Create an instance of this class.
         *
         *  @return Pointer to the newly created instance.
         */
        static SteeringBehaviorBuilder *create();
        /**
         ...
         *  @return Pointer to the newly created instance.
         */
        static SteeringBehaviorBuilder *clone(const SteeringBehaviorBuilder &object);
        /**
         *  Destroy an instance of this class.
         *
         *  @param object The object to destroy.
         */
        static void destroy(SteeringBehaviorBuilder *object);
        /**
         ...
         */
        static void load(SteeringBehaviorBuilder &object, lua_State *L, int stack_index);
        /**
         *  Get the type of ::jliObjectEnumType enum value.
         *
         *  @return The ::jliObjectEnumType enum value.
...
#endif /* SteeringBehaviorBuilder_hpp */
