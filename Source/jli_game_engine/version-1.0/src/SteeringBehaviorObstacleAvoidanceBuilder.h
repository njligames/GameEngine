...
namespace njli
{
     ...
     *  Builder for <#CLASS#>
     */
    ATTRIBUTE_ALIGNED16(class) SteeringBehaviorObstacleAvoidanceBuilder :
    public AbstractBuilder
    {
        friend class WorldFactory;
    protected:
        SteeringBehaviorObstacleAvoidanceBuilder();
        SteeringBehaviorObstacleAvoidanceBuilder(const SteeringBehaviorObstacleAvoidanceBuilder &);
        BT_DECLARE_ALIGNED_ALLOCATOR();
        virtual ~SteeringBehaviorObstacleAvoidanceBuilder();
        
        SteeringBehaviorObstacleAvoidanceBuilder &operator=(const SteeringBehaviorObstacleAvoidanceBuilder &);
    ...
    public:
         ...
         */
        static SteeringBehaviorObstacleAvoidanceBuilder **createArray(const u32 size);
        /**
         *  Destroy an Array of this class type.
         *
         *  @param array The Pointer to the array to delete.
         */
        static void destroyArray(SteeringBehaviorObstacleAvoidanceBuilder **array, const u32 size = 0);
        /**
         ...
         *  @return Pointer to the newly created instance.
         */
        static SteeringBehaviorObstacleAvoidanceBuilder *clone(const SteeringBehaviorObstacleAvoidanceBuilder &object);
        /**
         ...
         */
        static void load(SteeringBehaviorObstacleAvoidanceBuilder &object, lua_State *L, int stack_index);
        /**
         *  Get the type of ::jliObjectEnumType enum value.
         *
         *  @return The ::jliObjectEnumType enum value.
