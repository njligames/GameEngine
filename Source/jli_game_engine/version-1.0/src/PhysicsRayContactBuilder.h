...
namespace njli
{
    ATTRIBUTE_ALIGNED16(class) PhysicsRayContactBuilder :
    ...
    public:
         ...
         */
        static void destroyArray(PhysicsRayContactBuilder **array, const u32 size = 0);
        /**
         *  <#Description#>
         *
         *  @return <#return value description#>
         ...
         *  @return <#return value description#>
         */
        static PhysicsRayContactBuilder *clone(const PhysicsRayContactBuilder &object);
        /**
         *  <#Description#>
         *
         *  @param object <#object description#>
         ...
         */
        static void load(PhysicsRayContactBuilder &object, lua_State *L, int stack_index);
        /**
         *  <#Description#>
         *
         *  @return <#return value description#>
