...
namespace njli
{
     ...
     */
    ATTRIBUTE_ALIGNED16(class) SteeringBehaviorMachinePrioritizedBuilder :
    public AbstractBuilder
    {
        friend class WorldFactory;
    protected:
        SteeringBehaviorMachinePrioritizedBuilder();
        SteeringBehaviorMachinePrioritizedBuilder(const SteeringBehaviorMachinePrioritizedBuilder &);
        BT_DECLARE_ALIGNED_ALLOCATOR();
        virtual ~SteeringBehaviorMachinePrioritizedBuilder();
        
        SteeringBehaviorMachinePrioritizedBuilder &operator=(const SteeringBehaviorMachinePrioritizedBuilder &);
    ...
    public:
         ...
         */
        static SteeringBehaviorMachinePrioritizedBuilder **createArray(const u32 size);
        /**
         *  Destroy an Array of this class type.
         *
         *  @param array The Pointer to the array to delete.
         */
        static void destroyArray(SteeringBehaviorMachinePrioritizedBuilder **array, const u32 size = 0);
        /**
         ...
         *  @return Pointer to the newly created instance.
         */
        static SteeringBehaviorMachinePrioritizedBuilder *clone(const SteeringBehaviorMachinePrioritizedBuilder &object);
        /**
         ...
         */
        static void load(SteeringBehaviorMachinePrioritizedBuilder &object, lua_State *L, int stack_index);
        /**
         *  Get the type of ::jliObjectEnumType enum value.
         *
         *  @return The ::jliObjectEnumType enum value.
