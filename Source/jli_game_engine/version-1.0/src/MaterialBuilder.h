...
namespace njli
{
    ...
    public:
         ...
         *  @return <#return value description#>
         */
        static MaterialBuilder **createArray(const u32 size);
        /**
         *  <#Description#>
         *
         *  @param array <#array description#>
         */
        static void destroyArray(MaterialBuilder **array, const u32 size = 0);
        /**
         *  <#Description#>
         *
         *  @return <#return value description#>
         */
        static MaterialBuilder *create();
        /**
         *  <#Description#>
         *
         ...
         *  @return <#return value description#>
         */
        static MaterialBuilder *clone(const MaterialBuilder &object);
        /**
         *  <#Description#>
         *
         *  @param object <#object description#>
         */
        static void destroy(MaterialBuilder *object);
        /**
         *  <#Description#>
         *
         *  @param object      <#object description#>
         ...
         */
        static void load(MaterialBuilder &object, lua_State *L, int stack_index);
        /**
         *  <#Description#>
         *
         *  @return <#return value description#>
