...
namespace njli
{
     ...
     *  <#Description#>
     */
    ATTRIBUTE_ALIGNED16(class) PhysicsConstraintSliderBuilder :
    ...
    protected:
        ...
        PhysicsConstraintSliderBuilder &operator=(const PhysicsConstraintSliderBuilder &);
    ...
    public:
         ...
         */
        static void destroyArray(PhysicsConstraintSliderBuilder **array, const u32 size = 0);
        /**
         *  <#Description#>
         *
         *  @return <#return value description#>
         ...
         *  @return <#return value description#>
         */
        static PhysicsConstraintSliderBuilder *clone(const PhysicsConstraintSliderBuilder &object);
        /**
         *  <#Description#>
         *
         *  @param object <#object description#>
         ...
         */
        static void load(PhysicsConstraintSliderBuilder &object, lua_State *L, int stack_index);
        /**
         *  <#Description#>
         *
         *  @return <#return value description#>
