...
namespace njli
{
     ...
     *  <#Description#>
     */
    ATTRIBUTE_ALIGNED16(class) PhysicsShapeConvexHullBuilder :
    ...
    protected:
        ...
        PhysicsShapeConvexHullBuilder &operator=(const PhysicsShapeConvexHullBuilder &);
    ...
    public:
         ...
         */
        static void destroyArray(PhysicsShapeConvexHullBuilder **array, const u32 size = 0);
        /**
         *  <#Description#>
         *
         *  @return <#return value description#>
         ...
         *  @return <#return value description#>
         */
        static PhysicsShapeConvexHullBuilder *clone(const PhysicsShapeConvexHullBuilder &object);
        /**
         *  <#Description#>
         *
         *  @param object <#object description#>
         ...
         */
        static void load(PhysicsShapeConvexHullBuilder &object, lua_State *L, int stack_index);
        /**
         *  <#Description#>
         *
         *  @return <#return value description#>
