//
//  SteeringBehaviorEvadeBuilder.h
//  NJLIGameEngine_iOS
//
...
#ifndef SteeringBehaviorEvadeBuilder_hpp
#define SteeringBehaviorEvadeBuilder_hpp
...
namespace njli
{
     ...
     *  Builder for <#CLASS#>
     */
    ATTRIBUTE_ALIGNED16(class) SteeringBehaviorEvadeBuilder :
    public AbstractBuilder
    {
        friend class WorldFactory;
    protected:
        SteeringBehaviorEvadeBuilder();
        SteeringBehaviorEvadeBuilder(const SteeringBehaviorEvadeBuilder &);
        BT_DECLARE_ALIGNED_ALLOCATOR();
        virtual ~SteeringBehaviorEvadeBuilder();
        
        SteeringBehaviorEvadeBuilder &operator=(const SteeringBehaviorEvadeBuilder &);
    ...
    public:
         ...
         */
        static SteeringBehaviorEvadeBuilder **createArray(const u32 size);
        /**
         *  Destroy an Array of this class type.
         *
         *  @param array The Pointer to the array to delete.
         */
        static void destroyArray(SteeringBehaviorEvadeBuilder **array, const u32 size = 0);
        /**
         *  Create an instance of this class.
         *
         *  @return Pointer to the newly created instance.
         */
        static SteeringBehaviorEvadeBuilder *create();
        /**
         ...
         *  @return Pointer to the newly created instance.
         */
        static SteeringBehaviorEvadeBuilder *clone(const SteeringBehaviorEvadeBuilder &object);
        /**
         *  Destroy an instance of this class.
         *
         *  @param object The object to destroy.
         */
        static void destroy(SteeringBehaviorEvadeBuilder *object);
        /**
         ...
         */
        static void load(SteeringBehaviorEvadeBuilder &object, lua_State *L, int stack_index);
        /**
         *  Get the type of ::jliObjectEnumType enum value.
         *
         *  @return The ::jliObjectEnumType enum value.
...
#endif /* SteeringBehaviorEvadeBuilder_hpp */
