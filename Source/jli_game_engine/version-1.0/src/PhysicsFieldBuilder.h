...
//    class PhysicsFieldBuilder:
    ...
    public:
        ...
        /**
         *  @author James Folk, 16-02-11 15:02:14
         *
         *  @brief <#Description#>
         *
         ...
         *  @return <#return value description#>
         */
        static PhysicsFieldBuilder **createArray(const u32 size);
        /**
         *  <#Description#>
         *
         *  @param array <#array description#>
         */
        static void destroyArray(PhysicsFieldBuilder **array, const u32 size = 0);
        /**
         *  <#Description#>
         *
         *  @return <#return value description#>
         */
        static PhysicsFieldBuilder *create();
        /**
         *  <#Description#>
         *
         ...
         *  @return <#return value description#>
         */
        static PhysicsFieldBuilder *clone(const PhysicsFieldBuilder &object);
        /**
         *  <#Description#>
         *
         *  @param object <#object description#>
         */
        static void destroy(PhysicsFieldBuilder *object);
        /**
         *  <#Description#>
         *
         *  @param object      <#object description#>
         ...
         */
        static void load(PhysicsFieldBuilder &object, lua_State *L, int stack_index);
        /**
         *  <#Description#>
         *
         *  @return <#return value description#>
