...
namespace njli
{
     ...
     *  <#Description#>
     */
    ATTRIBUTE_ALIGNED16(class) SteeringBehaviorMachinePrioritized:
    public SteeringBehaviorMachine
    {
        friend class WorldFactory;
    protected:
        SteeringBehaviorMachinePrioritized();
        SteeringBehaviorMachinePrioritized(const AbstractBuilder&);
        SteeringBehaviorMachinePrioritized(const SteeringBehaviorMachinePrioritized &);
        BT_DECLARE_ALIGNED_ALLOCATOR();
        virtual ~SteeringBehaviorMachinePrioritized();
        SteeringBehaviorMachinePrioritized &operator=(const SteeringBehaviorMachinePrioritized &);
    public:
         ...
         */
        static void destroyArray(SteeringBehaviorMachinePrioritized **array, const u32 size = 0);
        /**
         ...
         *  @return Pointer to the newly created instance.
         */
        static SteeringBehaviorMachinePrioritized *create(const SteeringBehaviorMachinePrioritizedBuilder &builder);
        /**
         ...
         *  @return Pointer to the newly created instance.
         */
        static SteeringBehaviorMachinePrioritized *clone(const SteeringBehaviorMachinePrioritized &object);
        /**
         ...
         *  @return Pointer to the newly created instance.
         */
        static SteeringBehaviorMachinePrioritized *copy(const SteeringBehaviorMachinePrioritized &object);
        /**
         ...
         */
        static void load(SteeringBehaviorMachinePrioritized &object, lua_State *L, int stack_index);
        /**
         *  Get the type of ::jliObjectEnumType enum value.
         *
         *  @return The ::jliObjectEnumType enum value.
