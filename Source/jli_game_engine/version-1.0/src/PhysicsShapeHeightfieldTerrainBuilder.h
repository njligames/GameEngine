...
namespace njli
{
     ...
     *  <#Description#>
     */
    ATTRIBUTE_ALIGNED16(class) PhysicsShapeHeightfieldTerrainBuilder :
    public AbstractBuilder
    {
        friend class WorldFactory;
    protected:
        PhysicsShapeHeightfieldTerrainBuilder();
        PhysicsShapeHeightfieldTerrainBuilder(const PhysicsShapeHeightfieldTerrainBuilder &);
        BT_DECLARE_ALIGNED_ALLOCATOR();
        virtual ~PhysicsShapeHeightfieldTerrainBuilder();
        
        PhysicsShapeHeightfieldTerrainBuilder &operator=(const PhysicsShapeHeightfieldTerrainBuilder &);
    ...
    public:
         ...
         */
        static void destroyArray(PhysicsShapeHeightfieldTerrainBuilder **array, const u32 size = 0);
        /**
         *  <#Description#>
         *
         *  @return <#return value description#>
         ...
         *  @return <#return value description#>
         */
        static PhysicsShapeHeightfieldTerrainBuilder *clone(const PhysicsShapeHeightfieldTerrainBuilder &object);
        /**
         *  <#Description#>
         *
         *  @param object <#object description#>
         ...
         */
        static void load(PhysicsShapeHeightfieldTerrainBuilder &object, lua_State *L, int stack_index);
        /**
         *  <#Description#>
         *
         *  @return <#return value description#>
