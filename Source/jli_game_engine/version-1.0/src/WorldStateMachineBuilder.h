...
namespace njli
{
    ...
    public:
         ...
         *  @return <#return value description#>
         */
        static WorldStateMachineBuilder **createArray(const u32 size);
        /**
         *  <#Description#>
         *
         *  @param array <#array description#>
         */
        static void destroyArray(WorldStateMachineBuilder **array, const u32 size = 0);
        /**
         *  <#Description#>
         *
         *  @return <#return value description#>
         */
        static WorldStateMachineBuilder *create();
        /**
         *  <#Description#>
         *
         ...
         *  @return <#return value description#>
         */
        static WorldStateMachineBuilder *clone(const WorldStateMachineBuilder &object);
        /**
         *  <#Description#>
         *
         *  @param object <#object description#>
         */
        static void destroy(WorldStateMachineBuilder *object);
        /**
         *  <#Description#>
         *
         *  @param object      <#object description#>
         ...
         */
        static void load(WorldStateMachineBuilder &object, lua_State *L, int stack_index);
        /**
         *  <#Description#>
         *
         *  @return <#return value description#>
