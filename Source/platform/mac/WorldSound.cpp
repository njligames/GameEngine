...
#define FMOD_ERRCHECK(_result)                        \
    do {                                              \
        if (FMOD_LOGGING_ON)                          \
            ERRCHECK_fn(_result, __FILE__, __LINE__); \
    } while (0)
...
//        DEBUG_LOG_PRINT_V(TAG, "%d bytes.\n", (int)commanddata2);
    ...
    case FMOD_SYSTEM_CALLBACK_THREADCREATED: {
        ...
        //            DEBUG_LOG_PRINT_V(TAG, "Thread ID = %d\n", (int)commanddata1);
        //            DEBUG_LOG_PRINT_V(TAG, "Thread Name = %s\n", (char *)commanddata2);
    } break;
    ...
    case FMOD_SYSTEM_CALLBACK_PREMIX: {
        //            DEBUG_LOG_WRITE_V(TAG, "NOTE : FMOD_SYSTEM_CALLBACK_PREMIX occured.\n");
    } break;
    case FMOD_SYSTEM_CALLBACK_POSTMIX: {
        //            DEBUG_LOG_WRITE_V(TAG, "NOTE : FMOD_SYSTEM_CALLBACK_POSTMIX occured.\n");
    } break;
    case FMOD_SYSTEM_CALLBACK_ERROR: {
        ...
        //            DEBUG_LOG_WRITE_V(TAG, "NOTE : FMOD_SYSTEM_CALLBACK_ERROR occured.\n");
    } break;
    case FMOD_SYSTEM_CALLBACK_MIDMIX: {
        //            DEBUG_LOG_WRITE_V(TAG, "NOTE : FMOD_SYSTEM_CALLBACK_MIDMIX occured.\n");
    } break;
    case FMOD_SYSTEM_CALLBACK_THREADDESTROYED: {
        DEBUG_LOG_WRITE_V(TAG, "NOTE : FMOD_SYSTEM_CALLBACK_THREADDESTROYED occured.\n");
    } break;
    case FMOD_SYSTEM_CALLBACK_PREUPDATE: {
        //            DEBUG_LOG_WRITE_V(TAG, "NOTE : FMOD_SYSTEM_CALLBACK_PREUPDATE occured.\n");
    } break;
    case FMOD_SYSTEM_CALLBACK_POSTUPDATE: {
        //            DEBUG_LOG_WRITE_V(TAG, "NOTE : FMOD_SYSTEM_CALLBACK_POSTUPDATE occured.\n");
    } break;
    }
...
WorldSound::WorldSound()
{
    ...
    if (version < FMOD_VERSION) {
        DEBUG_LOG_PRINT_E(TAG, "FMOD lib version %08x doesn't match header version %08x", version, FMOD_VERSION);
    }
    result = m_System->init(MAXCHANNELS, FMOD_INIT_NORMAL | FMOD_INIT_PROFILE_ENABLE, 0);
    FMOD_ERRCHECK(result);
...
FMOD::Channel* WorldSound::getChannel(s32 channelindex)
{
    ...
    //
    //        DEBUG_LOG_PRINT_D(TAG, "Number of Channels Playing %d", channels);
