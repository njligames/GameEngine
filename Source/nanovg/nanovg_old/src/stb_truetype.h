#include "../../../../third_party/platform/core/File.h"
...
{
   fread(ttf_buffer, 1, 1<<20, jli_fopen("c:/windows/fonts/times.ttf", "rb"));
...
int main(int argc, char **argv)
{
   ...
   fread(ttf_buffer, 1, 1<<25, jli_fopen(argc > 3 ? argv[3] : "c:/windows/fonts/arialbd.ttf", "rb"));
...
int main(int arg, char **argv)
{
   ...
   fread(buffer, 1, 1000000, jli_fopen("c:/windows/fonts/arialbd.ttf", "rb"));
