...
{
   fread(ttf_buffer, 1, 1<<20, njli_fopen("c:/windows/fonts/times.ttf", "rb"));
...
int main(int argc, char **argv)
{
   ...
   fread(ttf_buffer, 1, 1<<25, njli_fopen(argc > 3 ? argv[3] : "c:/windows/fonts/arialbd.ttf", "rb"));
...
int main(int arg, char **argv)
{
   ...
   fread(buffer, 1, 1000000, njli_fopen("c:/windows/fonts/arialbd.ttf", "rb"));
