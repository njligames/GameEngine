...
local japaneseFont = JLI.World.getInstance():getWorldHUD():createFont("sans-jp", "fonts/DroidSansJapanese.ttf")
if (japaneseFont == -1) then
...
local buttonHUD = JLI.ButtonHUD.create()
material:getDiffuse():loadGPU(buttonHUD);
