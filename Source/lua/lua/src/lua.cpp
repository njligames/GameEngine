...
//{
//  njli::NJLIGameEngine::resize(0, 0, 250, 250, 0);
//}
//
...
//  {
//    enterCode = 0;
//    njli::World::getInstance()->getWorldLuaVirtualMachine()->doREPL();
//  }
//  
//
...
//  win = glutCreateWindow ("NJLIGameEngine Sandbox");
...
//
//  njli::NJLIGameEngine::create(0, 0, 250, 250, 0, "MAC", false);
//  int ret = njli::World::getInstance()->getWorldLuaVirtualMachine()->initLua(argc, argv);
//
//  glutMainLoop();
//
//  return ret;
