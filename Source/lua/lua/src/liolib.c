...
#include "../../../../Source/platform/core/Log.h"
#define liolib_c
#define LUA_LIB
...
/*
** Change this macro to accept other modes for 'njli_fopen' besides
** the standard ones.
*/
#if !defined(l_checkmode)

/* accepted extensions to 'mode' in 'njli_fopen' */
