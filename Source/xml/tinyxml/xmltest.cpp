...
int main_xml()
{
	...
	printf ("\n** UTF-8 **\n");
	{
		...
		else
		{
			...
			FILE* saved  = njli_fopen( "utf8testout.xml", "r" );
			FILE* verify = njli_fopen( "utf8testverify.xml", "r" );
...

	{
		...
		FILE* textfile = njli_fopen( "textfile.txt", "w" );
		if ( textfile )
		{
			psg->Print( textfile, 0 );
			fclose( textfile );
		}
		textfile = njli_fopen( "textfile.txt", "r" );
		assert( textfile );
		if ( textfile )
		{
			char buf[ 1024 ];
    ...
    {
		FILE* textfile = njli_fopen( "test5.xml", "w" );
		if ( textfile )
		{
	...
	{
		FILE* textfile = njli_fopen( "test6.xml", "w" );
		if ( textfile )
		{
