...
BULLET_CPP_OUTPUT="${SRC}/lua/lua/src/lbullet.cpp"
...
NJLI_XML_FILE="${SRC}/jli_game_engine/version-1.0/doc/swig/njli.xml"
NJLI_CPP_OUTPUT="${SRC}/lua/lua/src/lnjli.cpp"
NJLI_SYMBOL_FILE="${SRC}/jli_game_engine/version-1.0/doc/swig/lua-symbol-njli.txt"

LUA_RUNTIME_OUTPUT="${SRC}/lua/lua/src/njli_swig_runtime.h"
...
/usr/local/bin/swig -w312 -w201 -c++ -lua -debug-symbols -includeall -ignoremissing -I${BULLET_SOURCE} -I${BULLET_SOURCE0} -I${BULLET_SOURCE1} -I${BULLET_SOURCE2} -I${BULLET_SOURCE3} -I${BULLET_SOURCE4} -I${BULLET_SOURCE5} -I${BULLET_SOURCE6} -I${BULLET_SOURCE7} -I${BULLET_SOURCE8} -I${BULLET_SOURCE9} -I${BULLET_SOURCE10} -I${BULLET_SOURCE11} -I${BULLET_SOURCE12} -I${BULLET_SOURCE13} -I${BULLET_SOURCE14} -I${BULLET_SOURCE15} -I${BULLET_SOURCE16} -I${BULLET_SOURCE17} -I${BULLET_SOURCE18} -I${BULLET_SOURCE19} -features directors,autodoc=1 -DBT_INFINITY -xmlout ${BULLET_XML_FILE} -o ${BULLET_CPP_OUTPUT} ${BULLET_INTERFACE_FILE} > ${BULLET_SYMBOL_FILE}

#-w201 -w312 -w402

/usr/local/bin/swig -w312 -w201 -c++ -lua -debug-symbols -includeall -ignoremissing -I${BULLET_SOURCE} -I${BULLET_SOURCE0} -I${BULLET_SOURCE1} -I${BULLET_SOURCE2} -I${BULLET_SOURCE3} -I${BULLET_SOURCE4} -I${BULLET_SOURCE5} -I${BULLET_SOURCE6} -I${BULLET_SOURCE7} -I${BULLET_SOURCE8} -I${BULLET_SOURCE9} -I${BULLET_SOURCE10} -I${BULLET_SOURCE11} -I${BULLET_SOURCE12} -I${BULLET_SOURCE13} -I${BULLET_SOURCE14} -I${BULLET_SOURCE15} -I${BULLET_SOURCE16} -I${BULLET_SOURCE17} -I${BULLET_SOURCE18} -I${BULLET_SOURCE19} -I${NJLI_CORE_SOURCE} -I${NJLI_SOURCE} -features directors,autodoc=1 -xmlout ${NJLI_XML_FILE} -o ${NJLI_CPP_OUTPUT} ${NJLI_INTERFACE_FILE} > ${NJLI_SYMBOL_FILE}
