...
//    UIInterfaceOrientation orientation = [[UIApplication sharedApplication] statusBarOrientation];
    njli::NJLIGameEngine::create(0, 0, view.frame.size.width * view.contentScaleFactor, view.frame.size.height * view.contentScaleFactor, 0, [[UIDeviceUtil hardwareDescription] UTF8String]);
}
...
//    UIInterfaceOrientation orientation = [[UIApplication sharedApplication] statusBarOrientation];
    njli::NJLIGameEngine::resize(0, 0, view.frame.size.width * view.contentScaleFactor, view.frame.size.height * view.contentScaleFactor, 0);
}
